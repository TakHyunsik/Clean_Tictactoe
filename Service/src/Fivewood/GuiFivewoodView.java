...
public class GuiFivewoodView extends JFrame implements MouseListener {
	...
	JButton startNewGame = new JButton("ªı ∞‘¿” Ω√¿€");
	...
	public void setWindow() {
		...
		for (int i = 0; i < SIZE * SIZE; i++) {
			// »≠ÔøΩÔøΩ ≈©ÔøΩÔøΩ ÔøΩÔøΩÔøΩÔøΩÔøΩœ±ÔøΩ
	...
	public void mousePressed(MouseEvent e) {
		...
		if (tempButton.getText().equals("O") || tempButton.getText().equals("X")) {
			JOptionPane.showMessageDialog(AllRoom, "¿ÃπÃ µ– ¿ßƒ°¿‘¥œ¥Ÿ.");
			return;
...
//				System.out.println(board[i][j]);
		...
		if (result == PlayerType.P1 || result == PlayerType.P2) {
			JOptionPane.showMessageDialog(AllRoom, "∞‘¿”¿Ã ≥°≥µΩ¿¥œ¥Ÿ. " + result + " ¿Ã Ω¬∏Æ«œºÃΩ¿¥œ¥Ÿ.");
			...
			JOptionPane.showMessageDialog(AllRoom, "¿ÃπÃ ∞‘¿”¿Ã ≥°≥µΩ¿¥œ¥Ÿ.");
			isGameEnd = true;
		}
